...
class PokinatorCore:
    ...
    def __init__(self, spi_clock, spi_mosi, spi_miso, dir_pin_id, lead_mm=10, spr=1600, lc_offset=None, lc_gain=None):
    ...
    def move_axis_distance(self, axis_name, distance_mm, target_rpm=240, max_force_g=None):
        """
